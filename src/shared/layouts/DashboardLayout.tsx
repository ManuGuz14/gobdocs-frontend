...
export const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col relative overflow-hidden">
      ...
      {/* CHAT BUTTON */}
      <button
        className={`fixed bottom-8 right-8 bg-white text-gobdocs-primary p-4 rounded-full shadow-2xl hover:scale-110 transition-all z-50 border-2 border-blue-50 group ${
